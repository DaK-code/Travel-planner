...
})(
  {
    db3ss: [
      function (require, module, exports, __globalThis) {
        ...
        module.bundle.HMR_BUNDLE_ID = "1da3ac231fd24ada";
        ("use strict");
...
${frame.code}`;
    ...
    f2QDv: [
      function (require, module, exports, __globalThis) {
        /* eslint-disable */ var _signup = require("./signup");
        var _login = require("./login");
        console.log("Index charg\xe9 avec succ\xe8s");
        // ===============================
        // SIGN UP FORM
        // ===============================
    ...
    "5By4s": [
      function (require, module, exports, __globalThis) {
         ...
         */ const isPlainObject = (val) => {
          ...
          return (
            (prototype === null ||
              ...
              getPrototypeOf(prototype) === null) && // Treat any genuine (non-Object.prototype-polluted) Symbol.toStringTag or
        ...
        const G = getGlobal();
        const FormDataCtor =
          typeof G.FormData !== "undefined" ? G.FormData : undefined;
         ...
         */ function merge(...objs) {
          ...
          const assignValue = (val, key) => {
            ...
            const targetKey =
              (caseless && typeof key === "string" && findKey(result, key)) ||
              key;
         ...
         */ const isSafeIterable = (thing) =>
          thing != null &&
          hasOwnInPrototypeChain(thing, iterator) &&
          isIterable(thing);
        exports.default = {
          isArray,
          isArrayBuffer,
            ...
            while (i < len) {
              ...
              try {
                ...
                try {
                  ...
                  if ((0, _utilsJsDefault.default).isThenable(rejectedResult))
                    promise = Promise.resolve(rejectedResult).then(() =>
                      (0, _dispatchRequestJsDefault.default).call(
                        this,
                        newConfig,
                      ),
                    );
            ...
            /*eslint func-names:0*/ Axios.prototype[method] = function (
              ...
              return this.request(
                (0, _mergeConfigJsDefault.default)(config || {}, {
                  ...
                  data:
                    config &&
                    (0, _utilsJsDefault.default).hasOwnProp(config, "data")
                      ? config.data
                      : undefined,
                }),
              );
    ...
    "3bwC2": [
      function (require, module, exports, __globalThis) {
        ...
        function buildURL(url, params, options) {
          ...
          const _encode =
            (0, _utilsJsDefault.default).getSafeProp(_options, "encode") ||
            encode;
          const serializeFn = (0, _utilsJsDefault.default).getSafeProp(
            _options,
            "serialize",
          );
    ...
    ajoez: [
      function (require, module, exports, __globalThis) {
        ...
        var _bufferJs = require("../platform/node/classes/Buffer.js");
         ...
         */ function toFormData(obj, formData, options) {
          ...
          function convertValue(value) {
            ...
            if ((0, _utilsJsDefault.default).isBoolean(value))
            ...
            if (
              ...
              if (
                (0, _bufferJsDefault.default) &&
                (0, _bufferJsDefault.default).isBufferAvailable()
              )
                return (0, _bufferJsDefault.default).from(value);
              throw new (0, _axiosErrorJsDefault.default)(
                "Blob is not supported. Use a Buffer instead.",
            ...
            if (depth > maxDepth)
              throw new (0, _axiosErrorJsDefault.default)(
                "Object is too deeply nested (" +
                  ...
                  " levels). Max depth: " +
                  maxDepth,
                (0, _axiosErrorJsDefault.default).ERR_FORM_DATA_DEPTH_EXCEEDED,
              );
          }
          function stringifyWithDepthLimit(value, depth) {
            ...
            return JSON.stringify(
              value,
              function limitDepth(_key, currentValue) {
                if (!(0, _utilsJsDefault.default).isObject(currentValue))
                  return currentValue;
                while (
                  ancestors.length &&
           ...
           */ function defaultVisitor(value, key, path) {
            let arr = value;
            if (
              (0, _utilsJsDefault.default).isReactNative(formData) &&
              (0, _utilsJsDefault.default).isReactNativeBlob(value)
            ) {
      ...
      },
      {
        ...
        "../platform/node/classes/Buffer.js": "aFlee",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    "3u8Tl": [
      function (require, module, exports, __globalThis) {
        ...
        function hasOwnOrPrototypeToJSON(source) {
          if ((0, _utilsJsDefault.default).hasOwnProp(source, "toJSON"))
            return true;
          let prototype = Object.getPrototypeOf(source);
          while (prototype && prototype !== Object.prototype) {
            if ((0, _utilsJsDefault.default).hasOwnProp(prototype, "toJSON"))
              return true;
        ...
        function redactConfig(config, redactKeys) {
          const lowerKeys = new Set(
            redactKeys.map((k) => String(k).toLowerCase()),
          );
          const seen = [];
          const visit = (source) => {
            ...
            if (source instanceof (0, _axiosHeadersJsDefault.default))
            ...
            if ((0, _utilsJsDefault.default).isArray(source)) {
              ...
              source.forEach((v, i) => {
                ...
                if (!(0, _utilsJsDefault.default).isUndefined(reducedValue))
            ...
            .map((entry) => {
              try {
                return entry && entry.message
                  ? stringifySafely(entry.message)
                  : stringifySafely(entry);
              } catch (err) {
                return "";
              }
            })
        ...
        class AxiosError extends Error {
          static from(error, code, config, request, response, customProps) {
            ...
            if (
              !message &&
              (0, _utilsJsDefault.default).isArray(error.errors) &&
              error.errors.length
            )
          ...
          toJSON() {
            ...
            const redactKeys =
              config &&
              (0, _utilsJsDefault.default).hasOwnProp(config, "redact")
                ? config.redact
                : undefined;
            const serializedConfig =
              (0, _utilsJsDefault.default).isArray(redactKeys) &&
              redactKeys.length > 0
                ? redactConfig(config, redactKeys)
                : (0, _utilsJsDefault.default).toJSONObject(config);
            return {
              // Standard
    ...
    cgSSx: [
      function (require, module, exports, __globalThis) {
        ...
        function normalizeValue(value) {
          ...
          return (0, _utilsJsDefault.default).isArray(value)
            ...
            : (0, _sanitizeHeaderValueJs.sanitizeHeaderValue)(String(value));
        }
        ...
        class AxiosHeaders {
          ...
          set(header, valueOrRewrite, rewrite) {
            ...
            if (
              ...
              (0, _utilsJsDefault.default).isSafeIterable(header)
            ) {
      ...
      },
      {
        ...
        "../helpers/sanitizeHeaderValue.js": "fSESK",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    kqDd5: [
         ...
         */ exports.default = (rawHeaders) => {
          ...
          rawHeaders &&
            rawHeaders.split("\n").forEach(function parser(line) {
              ...
              const hasKey = (0, _utilsJsDefault.default).hasOwnProp(
                parsed,
                key,
              );
              if (
    ...
    hXfHM: [
      function (require, module, exports, __globalThis) {
        ...
        ("use strict");
        const own = (obj, key) =>
          obj != null && (0, _utilsJsDefault.default).hasOwnProp(obj, key)
            ? obj[key]
            : undefined;
        /**
        ...
        const defaults = {
          ...
          transformResponse: [
            function transformResponse(data) {
              const transitional =
                own(this, "transitional") || defaults.transitional;
          ...
          function buildPath(path, value, target, index) {
            ...
            if (isLast) {
              if ((0, _utilsJsDefault.default).hasOwnProp(target, name))
                target[name] = (0, _utilsJsDefault.default).isArray(
                  target[name],
                )
            ...
            if (
              !(0, _utilsJsDefault.default).hasOwnProp(target, name) ||
          ...
          function (config) {
            return new Promise(function dispatchXhrRequest(resolve, reject) {
              ...
              if ("onloadend" in request)
                ...
                request.onreadystatechange = function handleLoad() {
                  ...
                  if (
                    ...
                    !(
                      request.responseURL &&
                      request.responseURL.startsWith("file:")
                    )
                  )
                    return;
              ...
              request.onerror = function handleError(event) {
                ...
                const err = new (0, _axiosErrorJsDefault.default)(
                  msg,
              ...
              if ("setRequestHeader" in request)
                (0, _utilsJsDefault.default).forEach(
                  (0, _sanitizeHeaderValueJs.toByteStringHeaderObject)(
                    requestHeaders,
                  ),
              ...
              if (
                protocol &&
                !(0, _indexJsDefault.default).protocols.includes(protocol)
              ) {
                reject(
                  new (0, _axiosErrorJsDefault.default)(
    ...
    bN9Fp: [
      function (require, module, exports, __globalThis) {
        ...
        const progressEventReducer = (listener, isDownloadStream, freq = 3) => {
          ...
          return (0, _throttleJsDefault.default)((e) => {
            ...
            const loaded = Math.max(
              0,
              total != null ? Math.min(rawLoaded, total) : rawLoaded,
            );
        ...
        const asyncDecorator =
          (fn, scheduler = (0, _utilsJsDefault.default).asap) =>
          (...args) =>
            scheduler(() => fn(...args));
      },
      {
    ...
    l0e6d: [
      function (require, module, exports, __globalThis) {
        ...
        var _axiosHeadersJsDefault =
          parcelHelpers.interopDefault(_axiosHeadersJs);
        var _setFormDataHeadersJs = require("../core/setFormDataHeaders.js");
        var _setFormDataHeadersJsDefault = parcelHelpers.interopDefault(
          _setFormDataHeadersJs,
        );
        ...
        function resolveConfig(config) {
          ...
          const own = (key) =>
            (0, _utilsJsDefault.default).hasOwnProp(newConfig, key)
              ? newConfig[key]
              : undefined;
          const data = own("data");
          ...
          if (auth) {
            const username =
              (0, _utilsJsDefault.default).getSafeProp(auth, "username") || "";
            const password =
              (0, _utilsJsDefault.default).getSafeProp(auth, "password") || "";
            try {
              headers.set(
                "Authorization",
                "Basic " +
                  btoa(username + ":" + (password ? encodeUTF8(password) : "")),
              );
            } catch (e) {
              throw (0, _axiosErrorJsDefault.default).from(
                e,
          ...
          if ((0, _utilsJsDefault.default).isFormData(data)) {
            if (
              ...
              (0, _utilsJsDefault.default).isReactNative(data)
            )
              headers.setContentType(undefined); // browser/web worker/RN handles it
            else if ((0, _utilsJsDefault.default).isFunction(data.getHeaders))
              // Node.js FormData (like form-data package)
              (0, _setFormDataHeadersJsDefault.default)(
                headers,
                data.getHeaders(),
          ...
          if ((0, _indexJsDefault.default).hasStandardBrowserEnv) {
            if ((0, _utilsJsDefault.default).isFunction(withXSRFToken))
      ...
      },
      {
        ...
        "../core/mergeConfig.js": "b85oP",
        "../core/AxiosHeaders.js": "cgSSx",
        "../core/setFormDataHeaders.js": "J0PdG",
        "./buildURL.js": "3bwC2",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
        ...
        exports.default = (0, _indexJsDefault.default).hasStandardBrowserEnv
          ? {
              write(name, value, expires, path, domain, secure, sameSite) {
                ...
                if ((0, _utilsJsDefault.default).isString(sameSite))
      ...
      function (require, module, exports, __globalThis) {
        ...
        function redactFragment(fragment) {
          ...
          return fragment.replace(
            /(^|&)([^=&]*=)?[^&]+/g,
            (match, separator, parameterName = "") => {
              return `${separator}${parameterName}${(0, _axiosErrorJs.REDACTED)}`;
            },
          );
        }
        function redactSensitiveURLParts(url) {
          const redactedURL = url.replace(
            /^(https?:\/{0,2})[^/?#]*@/i,
            `$1${(0, _axiosErrorJs.REDACTED)}@`,
          );
          const fragmentIndex = redactedURL.indexOf("#");
          const urlWithoutFragment =
            fragmentIndex === -1
              ? redactedURL
              : redactedURL.slice(0, fragmentIndex);
          ...
          if (typeof url === "string") {
            ...
            if (malformedHttpProtocol.test(normalizedURL))
              throw new (0, _axiosErrorJsDefault.default)(
                ...
                (0, _axiosErrorJsDefault.default).ERR_INVALID_URL,
                config,
              );
          }
        }
      ...
      function (require, module, exports, __globalThis) {
          ...
          if (Object.getOwnPropertySymbols && Object.getOwnPropertyDescriptor)
            return Object.keys(thing).concat(
              Object.getOwnPropertySymbols(thing).filter(
                (symbol) =>
                  Object.getOwnPropertyDescriptor(thing, symbol).enumerable,
              ),
            );
        ...
        function mergeConfig(config1, config2) {
          ...
          function getMergedTransitionalOption(prop) {
            const transitional2 = (0, _utilsJsDefault.default).hasOwnProp(
              config2,
              "transitional",
            )
            ...
            if (!(0, _utilsJsDefault.default).isUndefined(transitional2)) {
              if ((0, _utilsJsDefault.default).isPlainObject(transitional2)) {
                if (
                  (0, _utilsJsDefault.default).hasOwnProp(transitional2, prop)
                )
                  return transitional2[prop];
              } else return undefined;
            }
            const transitional1 = (0, _utilsJsDefault.default).hasOwnProp(
              config1,
              "transitional",
            )
              ...
              : undefined;
            if (
              (0, _utilsJsDefault.default).isPlainObject(transitional1) &&
              (0, _utilsJsDefault.default).hasOwnProp(transitional1, prop)
            )
          ...
          function mergeDirectKeys(a, b, prop) {
            if ((0, _utilsJsDefault.default).hasOwnProp(config2, prop))
              return getMergedValue(a, b);
            else if ((0, _utilsJsDefault.default).hasOwnProp(config1, prop))
              return getMergedValue(undefined, a);
          }
          const mergeMap = {
          ...
          (0, _utilsJsDefault.default).forEach(
            ...
            function computeConfigValue(prop) {
              if (
                ...
                return;
              const merge = (0, _utilsJsDefault.default).hasOwnProp(
                mergeMap,
                prop,
              )
                ? mergeMap[prop]
                : mergeDeepProperties;
              const a = (0, _utilsJsDefault.default).hasOwnProp(config1, prop)
                ? config1[prop]
                : undefined;
              const b = (0, _utilsJsDefault.default).hasOwnProp(config2, prop)
                ? config2[prop]
                : undefined;
          ...
          if (
            ...
            (0, _utilsJsDefault.default).isUndefined(config2.validateStatus) &&
            getMergedTransitionalOption("validateStatusUndefinedResolves") ===
              false
          ) {
            if (
              (0, _utilsJsDefault.default).hasOwnProp(config1, "validateStatus")
            )
              config.validateStatus = getMergedValue(
                undefined,
                config1.validateStatus,
              );
    ...
    J0PdG: [
      function (require, module, exports, __globalThis) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        parcelHelpers.export(exports, "default", () => setFormDataHeaders);
        ("use strict");
    ...
    lVBFV: [
      function (require, module, exports, __globalThis) {
        ...
        var _estimateDataURLDecodedBytesJsDefault =
          parcelHelpers.interopDefault(_estimateDataURLDecodedBytesJs);
        var _dataJs = require("../env/data.js");
        var _sanitizeHeaderValueJs = require("../helpers/sanitizeHeaderValue.js");
        ...
        const factory = (env) => {
          const globalObject =
            (0, _utilsJsDefault.default).global !== undefined &&
            (0, _utilsJsDefault.default).global !== null
          ...
          return async (config) => {
            ...
            const hasMaxContentLength =
              (0, _utilsJsDefault.default).isNumber(maxContentLength) &&
              maxContentLength > -1;
            const hasMaxBodyLength =
              (0, _utilsJsDefault.default).isNumber(maxBodyLength) &&
              maxBodyLength > -1;
            const own = (key) =>
              (0, _utilsJsDefault.default).hasOwnProp(config, key)
                ? config[key]
                : undefined;
            ...
            try {
              ...
              if (configAuth) {
                const username =
                  (0, _utilsJsDefault.default).getSafeProp(
                    configAuth,
                    "username",
                  ) || "";
                const password =
              ...
              if (
                ...
                const estimated = (0,
                _estimateDataURLDecodedBytesJsDefault.default)(url);
              ...
              const resolvedOptions = {
                ...
                headers: (0, _sanitizeHeaderValueJs.toByteStringHeaderObject)(
                  headers.normalize(),
                ),
                body: data,
                duplex: "half",
              ...
              const responseHeaders = (0, _axiosHeadersJsDefault.default).from(
                response.headers,
              );
              // Cheap pre-check: if the server honestly declares a content-length that
              // already exceeds the cap, reject before we start streaming.
              if (hasMaxContentLength) {
                const declaredLength = (0,
              ...
              if (pendingBodyError) {
                request &&
                  !pendingBodyError.request &&
                  (pendingBodyError.request = request);
              ...
              if (
                ...
                const networkError = new (0, _axiosErrorJsDefault.default)(
                  "Network Error",
                  (0, _axiosErrorJsDefault.default).ERR_NETWORK,
                  config,
                  request,
      ...
      },
      {
        ...
        "../helpers/resolveConfig.js": "l0e6d",
        "../core/settle.js": "dD9aC",
        "../helpers/estimateDataURLDecodedBytes.js": "dzlhN",
        "../env/data.js": "h29L9",
        "../helpers/sanitizeHeaderValue.js": "fSESK",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ...
    dzlhN: [
      function (require, module, exports, __globalThis) {
        ...
        const hexValue = (charCode) =>
          charCode <= 57 ? charCode - 48 : (charCode & 0xdf) - 55;
        ...
        const estimatePercentDecodedBase64Bytes = (body) => {
          ...
          for (let i = 0; i < len; i++) {
            ...
            if (code === 37 /* '%' */ && isPercentEncodedByte(body, i, len)) {
              code =
                hexValue(body.charCodeAt(i + 1)) * 16 +
                hexValue(body.charCodeAt(i + 2));
              i += 2;
            }
        ...
        const estimateDataURLBytes = (url, estimateBase64) => {
          ...
          if (isBase64) return estimateBase64(body);
